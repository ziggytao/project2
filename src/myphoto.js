...
function display() {
    ...
    displayhttp.open("GET","myphoto.php?username="+username,false);
    displayhttp.send();
    document.getElementById("displayphoto").innerHTML = displayhttp.responseText;
    var btns = document.getElementsByClassName("delete-btn");
    var modbtns = document.getElementsByClassName("modify-btn");
...
function deletephoto(id) {
    ...
    delhttp.open("GET","deletephoto.php?username="+username+"&photoid="+id,false);
    delhttp.send();
    display();
}