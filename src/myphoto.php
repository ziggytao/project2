...
$sql = "SELECT travelimage.PATH,travelimage.Title,travelimage.ImageID,travelimage.Description  from travelimage,traveluser 
WHERE traveluser.UserName = '$username' and traveluser.UID = travelimage.UID";
